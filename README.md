...
**Mobile (MAUI – Android)**  
- APK prebuilt: [download here](https://github.com/Rona-code/StuAuthMobile/releases)  
- Or build yourself: clone → open in VS/Code with MAUI → run

**Desktop (WPF – Windows)**  
- Prebuilt EXE: [download here](https://github.com/Rona-code/StuAuth/releases)
- Or build yourself: clone → Visual Studio → build)

**Web Extension (Javascript – Firefox)**  
- XPI Prebuilt: [download here](https://github.com/Rona-code/StuAuthWeb/releases) 
